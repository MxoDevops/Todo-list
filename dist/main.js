...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Actions\": () => (/* binding */ Actions)\n/* harmony export */ });\n/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage.js */ \"./src/modules/storage.js\");\n\n\n/* eslint-disable */\nclass Actions {\n  static showTrash = (i) => {\n    document.getElementById(`trash-${i}`).classList.remove('hide');\n    document.getElementById(`ellipsis-${i}`).classList.add('hide');\n  };\n\n  static hideTrash = (i) => {\n    document.getElementById(`trash-${i}`).classList.add('hide');\n    document.getElementById(`ellipsis-${i}`).classList.remove('hide');\n  };\n\n  static removeTask = (i) => {\n    _storage_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].splice(i, 1);\n    _storage_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].forEach((item, index) => {\n      item.index = index;\n    });\n    localStorage.setItem('tasks', JSON.stringify(_storage_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]));\n    return true;\n  };\n\n  static addTask = (description, i) => {\n    _storage_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"][i].description = description;\n    localStorage.setItem('tasks', JSON.stringify(_storage_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]));\n    return true;\n  };\n}\n\n\n//# sourceURL=webpack://todo-list/./src/modules/crud.js?");
